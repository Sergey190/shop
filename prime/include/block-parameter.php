...
<label class="container"><input  '.$checked_brand.' type="checkbox" class="suka" name="brand[]" value="'.$row["id"].'" "id="checkbrend'.$row["id"].'" /> <span class="checkmark"></span><label  for="checkbrend'.$row["id"].'">'.$row["brand"].' </label></label>
