...
<li><label class="order_label_style" for="order_address"><span>*</span>Адрес<br /> доставки</label><input type="text" name="order_address" id="order_address" value="'.$_SESSION["order_address"].'" /><span>Пример: г. Харьков,<br /> ул Сумская д 22, кв 58</span></li>
';
}
echo '
...
<h2 class="itog-price" align="right">Итого: <strong>'.$itogpricecart.'</strong> грн</h2>
  <p align="right" class="button-next" ><a href="wm.php" >Оплатить</a></p> 
