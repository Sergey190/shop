...
<br>
<p style="font: 16px lucida console;">Интернет магазин <strong>Prime</strong> работает в соответствии с украинским законодательством о защите прав потребителей. Срок возврата составляет 14 календарных дней с момента доставки.
Ваши действия в случае возврата товара:</p><br>
<style type="text/css">
	
</style>
<ul style="font: 16px lucida console;">
<li>1.	Подготовить купленную вещь к возврату, а именно, упаковать товар в фирменную коробку или пакет Prime, полученный вами в момент поставки;</li>
