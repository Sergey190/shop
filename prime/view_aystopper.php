...
?>
	...
	<p id="breadcrumbs"><a href="index.php" >Главная страница</a> \ <span><?php echo $name_aystopper; ?></span></p>
</span></p>
<ul id="option">
	<li>Вид</li>
...
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=pupylar" >Популярное</a></li>
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&ssort=new"" >Новинки</a></li>
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=alphavit" >От А до Я</a></li>
			</ul>
	</li>
</ul>
</div>
